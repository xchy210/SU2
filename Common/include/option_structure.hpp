...
enum ENUM_SOLVER {
  ...
  DISC_ADJ_FEM_NS = 67,
  DISC_ADJ_FEM = 40,
  TNE2_EULER = 41,                   /*!< \brief Definition of the TNE2 Euler's solver. */
  TNE2_NAVIER_STOKES = 42,           /*!< \brief Definition of the TNE2 Navier-Stokes' solver. */
  TNE2_RANS = 43,                    /*!< \brief Definition of the TNE2 Reynolds-averaged Navier-Stokes' solver. */
  DISC_ADJ_TNE2_EULER = 44,          /*!< \brief Definition of the discrete adjoint TNE2 Euler solver. */
  DISC_ADJ_TNE2_NAVIER_STOKES = 45,  /*!< \brief Definition of the discrete adjoint TNE2 Navier-Stokes' solver. */
  DISC_ADJ_TNE2_RANS = 46,           /*!< \brief Definition of the discrete adjoint TNE2 RANS solver. */
