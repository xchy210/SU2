...
public:
   ...
   * \param[in] dPdU
   */
  virtual void CalcdPdU(su2double *V, su2double *val_eves, CConfig *config, su2double *dPdU);
   ...
   * \param[in] dTdU
   */
  virtual void CalcdTvedU(su2double *V, su2double *val_eves,
                          CConfig *config, su2double *dTdU);
  /*!
   * \brief A virtual member
   */
  virtual su2double *GetEve(void);

  /*!
   * \brief Returns the stored value of Cvve
   */
  virtual su2double *GetCvve(void);
